            ...
            <Col>
                ...
                <div>
                    <small>
                        <abbr>
                            <br />
                            Please leave this tab open while import is in progress...
                        </abbr>
                    </small>
                </div>
            </Col>
...
const ExecuteImportButton = ({ isEnabled, importPhase, importFunc, doneFunc }) => {
    switch (importPhase) {
        case ImportPhase.Completed:
            return (
                <Button variant="success" onClick={doneFunc} disabled={!isEnabled}>
                    Close
                </Button>
            );
        ...
        case ImportPhase.NotStarted:
            return (
                <Button variant="success" disabled={!isEnabled} onClick={importFunc}>
                    Import
                </Button>
            );
    ...
    return (
        <div {...rest}>
            <Alert variant="info">
                ...
                <a href="https://docs.lakefs.io/howto/import/" target="_blank" rel="noreferrer">
                    Learn more
                </a>
            </Alert>
            <Form>
...
export { startImport, ImportProgress, ImportDone, ExecuteImportButton, ImportForm, ImportPhase };
