            ...
            <Table bordered hover>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <code>{totalObjects.length.toLocaleString()}</code>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <code>
                                {totalBytes.toLocaleString()} Bytes ({humanSize(totalBytes)})
                            </code>
                        </td>
                    </tr>
                </tbody>
...
const OriginModal = ({ show, onHide, entry, repo, reference }) => {
    ...
    if (!loading && !error && commit) {
        content = <CommitInfoCard bare={true} repo={repo} commit={commit} />;
    }
