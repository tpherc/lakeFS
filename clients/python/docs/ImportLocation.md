...
------------ | ------------- | ------------- | -------------
**storage_id** | **str** | Configured backend containing this source. Omitted or empty uses the repository backend. | [optional] 
**type** | **str** | Path type, can either be &#39;common_prefix&#39; or &#39;object&#39; | 
**path** | **str** | A source location to a &#39;common_prefix&#39; or to a single object. Must match the selected backend&#39;s native address format. | 
